    ...
    >
      <Link
        href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(
          "Halo Satria Cengkara, saya ingin bertanya."
        )}`}
        target="_blank"
        ...
        className="relative flex h-12 w-12 cursor-grab touch-none items-center justify-center rounded-full bg-gradient-to-br from-green-400 to-green-600 shadow-lg shadow-green-500/30 active:cursor-grabbing"
      >
        <span className="absolute inset-0 animate-ping rounded-full bg-green-500 opacity-20" />
        <svg viewBox="0 0 24 24" fill="white" className="relative h-6 w-6">
